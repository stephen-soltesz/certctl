// Package certfile manages x509 certificates RSA key files.
// TODO: rewrite all of this. This is old funky code.
package certfile
...
func readPEMFile(pemFile string) ([]byte, error) {
	...
	if block == nil {
		return nil, errors.New(fmt.Sprintf("no PEM block found in %s", pemFile))
	}
